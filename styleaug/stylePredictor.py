...
class StylePredictor(nn.Module):
    ...
    def forward(self, x):
        ...
        # PyTorch InceptionV3 requires two preprocessing steps; one which is common to all PyTorch ImageNet models, and one which goes from that common preprocess to Google's Inception preproc, which is different:
